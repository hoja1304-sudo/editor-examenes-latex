...
\begin{tikzpicture}[scale=0.09]
  ...
  \node[anchor=south east, inner sep=1pt] at (0,21.05) {\scriptsize $y$ (norte)};
...
\begin{tikzpicture}[scale=0.16]
  ...
  \node[anchor=south east, inner sep=1pt] at (0,29.05) {$y$ (norte)};
...
\begin{tikzpicture}[scale=0.18]
  ...
  \node[anchor=south east, inner sep=1pt] at (0,8.05) {$y$ (norte)};
...
\begin{tikzpicture}[scale=0.34]
  ...
  \node[anchor=south east, inner sep=1pt] at (0,18.05) {$y$ (norte)};
...
\begin{tikzpicture}[scale=0.38]
  ...
  \node[anchor=south east, inner sep=1pt] at (0,15.05) {$y$ (norte)};
