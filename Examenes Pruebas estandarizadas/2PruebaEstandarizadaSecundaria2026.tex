...
\begin{tikzpicture}[scale=0.42]
  \path[use as bounding box] (-7.5,-8) rectangle (9,8.5);
  \draw[<->, thick] (-6.5,0) -- (6.5,0);
  \draw[<->, thick] (0,-7.5) -- (0,7.5);
  \node[anchor=west, inner sep=1pt] at (6.55,0) {\scriptsize $x$ (este)};
  \node[anchor=south, inner sep=1pt] at (0,7.85) {\scriptsize $y$ (norte)};
...
\begin{tikzpicture}[scale=0.25]
  \path[use as bounding box] (-8,-15) rectangle (18,13);
  \draw[<->, thick] (-7,0) -- (14,0);
  \draw[<->, thick] (0,-14) -- (0,12);
  \node[anchor=west, inner sep=1pt] at (14.1,0) {\tiny $x$ (este)};
  \node[anchor=south, inner sep=1pt] at (0,12.1) {\tiny $y$ (norte)};
  \draw[thick] (#1,#2) circle (#3);
  \draw[dashed] (#1,0) -- (#1,#2);
...
\begin{tikzpicture}[scale=0.4]
  \path[use as bounding box] (-4,-7) rectangle (14,11.5);
  \draw[<->, thick] (-3,0) -- (13,0);
  \draw[<->, thick] (0,-6) -- (0,11);
  \node[anchor=west, inner sep=1pt] at (13.05,0) {$x$ (este)};
  \node[anchor=south, inner sep=1pt] at (0,11.35) {$y$ (norte)};
...
\begin{enumerate}[label=\Alph*)]
  ...
  \opcion{B}{(x+4)^2+(y+3)^2=36}
  \opcion{C}{(x-4)^2+(y-3)^2=6}
...
\begin{center}
\begin{tikzpicture}[scale=0.4]
  \path[use as bounding box] (-9.5,-5) rectangle (7,11);
  \draw[<->, thick] (-8.5,0) -- (6,0);
  \draw[<->, thick] (0,-4) -- (0,10);
  \node[anchor=west, inner sep=1pt] at (6.05,0) {$x$ (este)};
  \node[anchor=south, inner sep=1pt] at (0,10.35) {$y$ (norte)};
...
\begin{tikzpicture}[scale=0.18]
  \path[use as bounding box] (-11,-12) rectangle (17,17);
  \draw[<->, thick] (-10,0) -- (16,0);
  \draw[<->, thick] (0,-11) -- (0,16);
  \node[anchor=west, inner sep=1pt] at (16.05,0) {\small $x$ (este)};
  \node[anchor=south, inner sep=1pt] at (0,16.35) {\small $y$ (norte)};
...
\begin{tikzpicture}[scale=0.45]
  \path[use as bounding box] (-3,-2) rectangle (9,12);
  \draw[<->, thick] (-2.5,0) -- (8,0);
  \draw[<->, thick] (0,-1.5) -- (0,11);
  \node[anchor=west, inner sep=1pt] at (8.05,0) {$x$ (este)};
  \node[anchor=south, inner sep=1pt] at (0,11.35) {$y$ (norte)};
